...
var MobxModel = function () {
    function MobxModel() {
        ...
        var _constants = (0, _utils.mapValues)(constants, function (value) {
            return { enumerable: true, configurable: true, writable: false, value: value };
        });
        ...
        if (this._plugin.hooks.onStateChange.length) {
            (0, _mobx.spy)(this._plugin.use('onStateChange'));
        }
    }
...
function toMobxSyncActions(name, syncs, plugin) {
    return (0, _utils.mapValues)(syncs, function (actionFn, actionName) {
        return function mobxAction() {
            ...
            // 执行钩子函数
            var result = (0, _mobx.action)(actionFn).apply(this, actionArgs);
...
function toMobxAsyncActions(modelName, actions) {
    ...
    return (0, _utils.mapValues)(actions, function (actionFn, actionName) {
        ...
        return function mobxAction() {
            ...
            return this._middleware.execAction({ actionFn: (0, _mobx.action)(actionFn), actionName: actionName, actionArgs: actionArgs, actionContext: actionContext }).then(function (payload) {
                // 3. loaded success
