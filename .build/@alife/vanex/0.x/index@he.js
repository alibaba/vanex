__def('@alife/vanex/0.x/index@he', ['require', 'mobx/3.x/index', 'mobx-react/4.x/index', 'react/15.x/index', 'invariant/2.x/index', 'is-plain-object/2.x/index', 'react-dom/15.x/index'], function(require) {
  return require('QGFsaWZlL3ZhbmV4LzAueC9pbmRleEBoZQ==');
});
__def('QGFsaWZlL3ZhbmV4LzAueC9pbmRleEBoZQ==', ['require', 'module', '@alife/vanex/0.x/src/index@he'], function (require, module) {
  module.exports = require('@alife/vanex/0.x/src/index@he');
});
__def('@alife/vanex/0.x/src/plugin/index@he', ['require', 'module', 'exports', 'invariant/2.x/index', 'is-plain-object/2.x/index'], function (require, module, exports, _index, _index3) {
...
__def('@alife/vanex/0.x/src/utils@he', ['require', 'exports', 'invariant/2.x/index', 'mobx/3.x/index'], function (require, exports, _index, _index3) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
...
__def('@alife/vanex/0.x/src/vanex-model@he', ['require', 'exports', 'mobx/3.x/index', '@alife/vanex/0.x/src/utils@he'], function (require, exports, _index, _utilsHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    var MobxModel = (_temp = _class = function () {
        function MobxModel() {
            ...
            // add constants
            var _constants = (0, _utilsHe.mapValues)(constants, function (value) {
                return {
                    enumerable: true,
                    configurable: true,
                    writable: false,
            ...
            // 自动执行的函数map
            (0, _utilsHe.each)(autorunMap, function (autorunFn) {
        ...
        MobxModel.prototype.toJS = function toJS(key) {
            ...
            function parse(val) {
                ...
                } else if ((0, _utilsHe.isRegExp)(val)) {
                    return val;
                } else if (val && (typeof val === 'undefined' ? 'undefined' : _typeof(val)) === 'object') {
                    return (0, _utilsHe.mapValues)(val, function (item) {
                        return parse(item);
                    });
                }
        ...
        MobxModel.prototype.set = function set(key, val) {
            ...
            if (typeof key === 'string') {
                ...
                (0, _index.runInAction)(function () {
                    return (0, _utilsHe.deepMapValues)(key, function (item) {
                        return item;
                    }, _this5);
                });
            }
    ...
    function toMobxSyncActions(name, syncs, plugin) {
        return (0, _utilsHe.mapValues)(syncs, function (actionFn, actionName) {
    ...
    function toMobxAsyncActions(modelName, actions) {
        ...
        return (0, _utilsHe.mapValues)(actions, function (actionFn, actionName) {
...
__def('@alife/vanex/0.x/src/vanex-relation@he', ['require', 'module', 'exports', '@alife/vanex/0.x/src/utils@he', 'mobx/3.x/index'], function (require, module, exports, _utilsHe, _index) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.default = undefined;
    ...
    var MobxRelation = function () {
        ...
        MobxRelation.prototype.listen = function listen(patterns, fn, errorFn) {
            ...
            } else if ((0, _utilsHe.isRegExp)(patterns)) {
        ...
        MobxRelation.prototype.execInMiddleware = function execInMiddleware(_ref) {
            ...
            this._relations.forEach(function (_ref2) {
                ...
                if (!(0, _utilsHe.isRegExp)(pattern.action) && fullname !== pattern.action || (0, _utilsHe.isRegExp)(pattern.action) && !pattern.action.test(fullname)) {
                    return;
                }
                ...
                try {
                    ...
                    (0, _utilsHe.compose)(chain, payload).then(function (res) {
        ...
        MobxRelation.prototype.parsePattern = function parsePattern(pattern) {
            ...
            if ((0, _utilsHe.isRegExp)(pattern)) {
...
__def('@alife/vanex/0.x/src/create-model@he', ['require', 'module', 'exports', '@alife/vanex/0.x/src/vanex-model@he', '@alife/vanex/0.x/src/utils@he'], function (require, module, exports, _vanexModelHe, _utilsHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.default = createModel;

    var _vanexModelHe2 = _interopRequireDefault(_vanexModelHe);
    ...
    function createModel(_ref) {
        var Parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _vanexModelHe2.default;
        ...
        if (!(0, _vanexModelHe.isMobxModelClass)(Parent)) {
        ...
        function MobxModel() {
            ...
            (0, _utilsHe.classCallCheck)(this, MobxModel);

            if (typeof data === 'function') {
                throw new Error('[createModel] `data` can not be a function, please use `init` instead.');
            }

            var mobxSyncs = (0, _vanexModelHe.toMobxSyncActions)(name, syncs, plugin);
            var mobxAsyncs = (0, _vanexModelHe.toMobxAsyncActions)(name, effects, plugin);

            _extends(this, mobxSyncs, mobxAsyncs);

            // Object.getPrototypeOf(MobxModel)指向_MobxModel的构造函数
            var res = (0, _utilsHe.possibleConstructorReturn)(this, Object.getPrototypeOf(MobxModel).call(this, _extends({}, data, _initData), middleware, plugin, _extends({}, autorun, _autorun), _extends({}, constants, _constants)));
        ...
        (0, _utilsHe.inherits)(MobxModel, Parent);
        ...
        Object.defineProperties(MobxModel, {
            name: {
                ...
                configurable: true,
                writable: false,
                value: (0, _utilsHe.nameToUpperCase)(name)
            }
        });
...
__def('@alife/vanex/0.x/src/middleware@he', ['require', 'module', 'exports', '@alife/vanex/0.x/src/utils@he'], function (require, module, exports, _utilsHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.default = undefined;
...
__def('@alife/vanex/0.x/src/vanex-middleware@he', ['require', 'exports', '@alife/vanex/0.x/src/utils@he', '@alife/vanex/0.x/src/middleware@he'], function (require, exports, _utilsHe, _middlewareHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ComposeMiddleware = undefined;

    var _middlewareHe2 = _interopRequireDefault(_middlewareHe);
    ...
    var ComposeMiddleware = exports.ComposeMiddleware = function () {
        ComposeMiddleware.toStandardMiddleware = function toStandardMiddleware() {
            ...
            if (typeof _middleware === 'function') {
                ...
                if (middleware.filter) {
                    ...
                    // to filter function
                    return (0, _utilsHe.mapValues)(middleware, function (res) {
        ...
        function ComposeMiddleware() {
            ...
            this._before = new _middlewareHe2.default();
            this._after = new _middlewareHe2.default();
            this._error = new _middlewareHe2.default();
        }
...
__def('@alife/vanex/0.x/src/vanex-context@he', ['require', 'module', 'exports', '@alife/vanex/0.x/src/vanex-model@he', '@alife/vanex/0.x/src/utils@he', '@alife/vanex/0.x/src/vanex-relation@he', '@alife/vanex/0.x/src/create-model@he', '@alife/vanex/0.x/src/vanex-middleware@he'], function (require, module, exports, _vanexModelHe, _utilsHe, _vanexRelationHe, _createModelHe, _vanexMiddlewareHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.default = undefined;
    ...
    var _vanexRelationHe2 = _interopRequireDefault(_vanexRelationHe);

    var _createModelHe2 = _interopRequireDefault(_createModelHe);

    var _vanexMiddlewareHe2 = _interopRequireDefault(_vanexMiddlewareHe);
    ...
    var MobxContext = function () {
        ...
        function MobxContext() {
            ...
            this._middleware = opts.middleware || _vanexMiddlewareHe2.default;
            this._relation = opts.relation || new _vanexRelationHe2.default();
        ...
        MobxContext.prototype.setData = function setData(models) {
            ...
            this._data = _extends({}, this._data, (0, _utilsHe.mapValues)(models, function (Model) {
                if ((0, _utilsHe.isObject)(Model)) {
                    Model = (0, _createModelHe2.default)(Model);
                }

                // Get a class
                if ((0, _vanexModelHe.isMobxModelClass)(Model)) {
                    var result = new Model(null, _this2._middleware, _this2._plugin);
                    return result;
                }

                // Get an instance
                if (Model instanceof _vanexModelHe2.default) {
        ...
        MobxContext.prototype.checkMobxModels = function checkMobxModels(mobxModels) {
            ...
            if (Array.isArray(mobxModels)) {
                ...
                (0, _utilsHe.each)(mobxModels, function (MobxModel, name) {
                    if (_this4._data[name]) {
                        if (!(0, _vanexModelHe.isMobxModelClass)(MobxModel)) {
...
__def('@alife/vanex/0.x/src/start@he', ['require', 'exports', 'react/15.x/index', '@alife/vanex/0.x/src/plugin/index@he', 'mobx-react/4.x/index', '@alife/vanex/0.x/src/vanex-context@he', '@alife/vanex/0.x/src/vanex-relation@he', '@alife/vanex/0.x/src/vanex-middleware@he', 'react-dom/15.x/index'], function (require, exports, _index, _indexHe, _index3, _vanexContextHe, _vanexRelationHe, _vanexMiddlewareHe, _index4) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    var _indexHe2 = _interopRequireDefault(_indexHe);

    var _vanexContextHe2 = _interopRequireDefault(_vanexContextHe);
    ...
    var globalPlugin = new _indexHe2.default();
    ...
    exports.default = function (_ref) {
        var ContainerComponent = _ref.component,
            ...
            relation = _ref$relation === undefined ? new _vanexRelationHe2.default() : _ref$relation;
        ...
        if (context) {
            ...
            context = new _vanexContextHe2.default(models, {
                middleware: _vanexMiddlewareHe2.default,
                relation: relation,
                plugin: globalPlugin
            });
        }
        ...
        if (containerEl) {
            ...
            (0, _index4.render)(_index2.default.createElement(VanexComponent, null), containerEl);
        } else {
            return VanexComponent;
        }
    };
    ...
    function use(plugin) {
        ...
        onEffect.forEach(function (item) {
            return _vanexMiddlewareHe2.default.use(item);
        });
...
__def('@alife/vanex/0.x/src/extend-model@he', ['require', 'module', 'exports', '@alife/vanex/0.x/src/create-model@he', '@alife/vanex/0.x/src/utils@he'], function (require, module, exports, _createModelHe, _utilsHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    function extendModel(parentModel) {
        ...
        if ((0, _utilsHe.isObject)(parentModel)) {
            parentModel = (0, _createModelHe2.default)(parentModel);
        }

        return (0, _createModelHe2.default)(configs, parentModel);
    }
    module.exports = exports['default'];
});
__def('@alife/vanex/0.x/src/index@he', ['require', 'module', 'exports', 'mobx/3.x/index', 'mobx-react/4.x/index', '@alife/vanex/0.x/src/start@he', '@alife/vanex/0.x/src/vanex-relation@he', '@alife/vanex/0.x/src/create-model@he', '@alife/vanex/0.x/src/extend-model@he'], function (require, module, exports, _index, _index2, _startHe, _vanexRelationHe, _createModelHe, _extendModelHe) {
    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    ...
    var _startHe2 = _interopRequireDefault(_startHe);

    var _vanexRelationHe2 = _interopRequireDefault(_vanexRelationHe);

    var _createModelHe2 = _interopRequireDefault(_createModelHe);

    var _extendModelHe2 = _interopRequireDefault(_extendModelHe);
    ...
    exports.default = _extends({}, mobx, mobxReact, {
        createModel: _createModelHe2.default,
        extendModel: _extendModelHe2.default,
        start: _startHe2.default,
        Relation: _vanexRelationHe2.default,
        addModel: _startHe.addModel,
        use: _startHe.use
    });
    module.exports = exports['default'];
});
//# sourceMappingURL=./index@he.js.map